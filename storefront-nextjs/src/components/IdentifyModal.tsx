...
export default function IdentifyModal({ isOpen, onClose, onIdentify }: IdentifyModalProps) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50" onClick={onClose}>
      <div className="bg-white rounded-lg shadow-xl w-11/12 md:w-1/3 lg:w-1/4 flex flex-col" onClick={e => e.stopPropagation()}>
        {/* Modal Header */}
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6">
            <p className="text-gray-600 mb-4">
              Para guardar tus productos favoritos y verlos en cualquier dispositivo, por favor, déjanos tu correo o teléfono.
            </p>
            <input
              type="text"
              value={identity}
